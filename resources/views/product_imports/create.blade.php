...
@section('content')
    <div class="card shadow-sm">
        <div class="card-body">
            <h4 class="card-title mb-3">Nhập hàng cho cửa hàng: {{ $store->name }}</h4>
            ...
            <form method="POST" action="{{ route('product-imports.store', $store) }}">
                @csrf
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="date"
                               id="import_date"
                               name="import_date"
                               value="{{ old('import_date', now()->toDateString()) }}"

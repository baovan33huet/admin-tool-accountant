...
@section('title', 'Thêm sản phẩm - ' . $store->name)

@section('content')
    <div class="card shadow-sm">
        <div class="card-body">
            <h4 class="card-title mb-3">Thêm sản phẩm cho cửa hàng: {{ $store->name }}</h4>
            ...
            <form method="POST" action="{{ route('products.store', $store) }}">
                @csrf
